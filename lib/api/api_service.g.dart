...
class _ApiService implements ApiService {
  ...
  Future<List<Images>> getImages() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Images>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/images',
  ...
  Future<List<Menu>> getMenus() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Menu>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/menus',
  ...
  Future<Menu?> getMenuByDate(String date) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Menu>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/menus/by-date',
    ...
    late Menu? _value;
    try {
      _value = _result.data == null ? null : Menu.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<Attendance>> getAttendances() async {
    ...
    try {
      _value = _result.data!
          .map(
            (dynamic i) => Attendance.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  Future<Attendance> getAttendanceById(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Attendance>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/attendance/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Attendance _value;
    try {
      _value = Attendance.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<Attendance> createAttendance(Attendance attendance) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(attendance.toJson());
    final _options = _setStreamType<Attendance>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<Attendance> updateAttendanceStatus(int id, String status) async {
    final _extra = <String, dynamic>{};
  ...
  Future<List<LeaveRequest>> getLeaveRequests() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<LeaveRequest>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/leave_requests',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<LeaveRequest> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => LeaveRequest.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  Future<LeaveRequest> getLeaveRequestById(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LeaveRequest>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/leave_requests/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LeaveRequest _value;
    try {
      _value = LeaveRequest.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<LeaveRequest> createLeaveRequest(LeaveRequest leaveRequest) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(leaveRequest.toJson());
    final _options = _setStreamType<LeaveRequest>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<LeaveRequest> updateLeaveRequestStatus(int id, String status) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'status': status};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
